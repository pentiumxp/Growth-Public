...
- Release-evidence-safe: release readiness is an evidence aggregate, not an
  ...
  dry-run, reviewed-target, config, and approval evidence, but it must not call
  Gateway,
