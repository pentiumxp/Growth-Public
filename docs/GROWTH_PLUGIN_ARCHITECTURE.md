...
8. Release-readiness evidence gate:
   ...
   - aggregate only summary-only evidence for product UI, audit UI, proposal /
     ...
     production action-handoff smoke, production scheduler-execution smoke,
     production scheduler-run smoke, reviewed worker-target smoke, reviewed
