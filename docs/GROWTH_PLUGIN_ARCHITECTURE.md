...
8. Release-readiness evidence gate:
   ...
   - aggregate only summary-only evidence for product UI, audit UI, proposal /
     ...
     handoffs, automation digest/action/execution/run/worker-target UI,
     production proposal smoke, production action-handoff smoke,
