...
- Release-evidence-safe: release readiness is an evidence aggregate, not an
  ...
  and approval evidence, but it must not call Gateway, daily-loop services,
  cycle-history services, publish, evaluate, schedule, activate stage
  assessments, deliver notifications, or mutate learner state.
