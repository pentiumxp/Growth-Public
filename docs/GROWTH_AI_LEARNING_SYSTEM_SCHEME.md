...
| Release-readiness evidence | `learning-automation-release-readiness-service`, `automation-release-readiness.js`; advisory summary-only release-review checks, remediation plan fields, platform action evidence, and snapshots. |
