...
| Release-readiness evidence | `learning-automation-release-readiness-service`, `automation-release-readiness.js`, `learning-automation-release-evidence-bundle-audit-service`, `learning-automation-release-collection-run-service`, `automation-release-collection-runs.js`; advisory summary-only release-review checks, remediation plan fields, platform action evidence, central visual evidence, release evidence bundle self-audit evidence, sanitized collection-run records, and snapshots. |
