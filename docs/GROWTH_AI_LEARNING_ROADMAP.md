...
| L9: Release-readiness evidence | Growth can summarize product, platform, visual, dry-run, reviewed-target, config, approval, cycle-history smoke, Owner audit smoke, profile-feedback smoke, controlled daily-loop write-smoke, learner-cycle audit smoke, platform action receipt evidence, central visual artifact evidence, smoke-bundle evidence, smoke-bundle self-audit, persisted collection-run evidence, release package artifacts, persisted package audit records, and package-record readback in release review/closure/controls without enabling execution or scheduling. | Release-readiness repository/service/route tests, release collection-run repository/service/route/script tests, release package repository/service/route/script tests, platform action evidence service/script tests, central visual evidence service/script tests, release evidence bundle service/script tests, release evidence bundle audit service/script tests, `tests/growth-release-readiness-smoke-script.test.js`, `tests/growth-release-collection-run-smoke-script.test.js`, `tests/growth-release-package-script.test.js`, `tests/learning-automation-release-package-repository.test.js`, `tests/growth-platform-action-evidence-smoke-script.test.js`, `tests/growth-central-visual-evidence-smoke-script.test.js`, `tests/growth-release-evidence-bundle-script.test.js`, `tests/growth-release-evidence-bundle-audit-smoke-script.test.js`, release approval bag collection through the bundle builder, default `cycle_history` bundle task coverage, default `owner_audit` bundle task coverage, default `profile_feedback` bundle task coverage, default `platform_action` bundle task coverage, default `central_visual` bundle task coverage, default audit-only `learner_cycle` bundle task coverage, explicit write-gated `daily_loop_write` bundle task coverage, bundle self-audit coverage for schema/summary/task/evidence/privacy/path checks, collection-run coverage for sanitized bundle/audit/readiness persistence, release package coverage for bundle/audit/readiness/collection-run/controls/dashboard composition and write-gated collection-run plus package-record persistence including dashboard summary, release-review/authorization/closure/controls package readback coverage, visible-target/Owner-only package API coverage, privacy rejection, disabled-config evidence, missing-evidence states, `releaseReview` remediation plan coverage for missing/blocked/evidence keys, package-record status, and next action, architecture no-Gateway/no-publication/no-evaluation/no-scheduler/no-Action-Inbox-internal/no-visual-tooling/no-stage-activation guard, docs-locality checks, and broad local validation pass. |
