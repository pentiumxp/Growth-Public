...
| Authoring layer | Generate validated teaching, practice, repair, stretch, integration, project, or assessment cards. | Daily English, daily science, generic subject-scoped daily practice, stage assessment generation, and planner-backed single-item publication are implemented. Subject-scoped compact recipes still pass through target provisioning, graph planning, graph evidence requirements, Gateway authoring, validation, summary-only rubric policy, and transactional publishing. | Expand the subject rubric catalog beyond the V1 daily policies while keeping broader objective selection on validated planner drafts. |
...
- richer subject-specific rubric catalogs and Owner audit rendering beyond the
  V1 English/science/generic daily policies.
...
6. add richer subject-specific rubric catalogs and Owner audit rendering after
   the V1 English/science/generic daily rubric policies are visually validated.
