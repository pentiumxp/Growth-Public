...
| CLI harness | `npm run smoke:cycle-closure -- --allow-write` delegates only to `learningAutomationCycleClosureService.prepareReviewPacket()` and mirrors bounded `automationCycleClosure*` readback fields. |
