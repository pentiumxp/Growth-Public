...
creation/review, digest/action review, and release evidence are browser-operable
...
5. Complete supervised proposal UI by adding proposal creation from a selected
   complete source cycle; keep review/publish on the existing proposal routes.
