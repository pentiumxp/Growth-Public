...
- release package CLI:
  ...
  sanitized audit row. The package is not release approval, runtime config
  enablement, scheduler permission, deployment, or card publication.
