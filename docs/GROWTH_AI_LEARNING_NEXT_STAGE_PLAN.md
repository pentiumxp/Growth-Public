...
- release workbench action smoke CLI:
  ...
  or `releaseCollectionRun` artifact. It does not build packages, run smoke
  tasks internally, publish, schedule, notify, call Gateway, flip runtime
