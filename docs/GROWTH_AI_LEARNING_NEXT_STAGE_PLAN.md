...
- Owner learning-loop state readback through `learning-loop-state-service`,
  ...
  readiness, active checkpoint state, next action, target/scope, readiness gates,
