...
- release dashboard readback smoke CLI:
  ...
  joining release services in the browser. It owns no repository/table, does
  not run smoke tasks internally, and does not write, publish, schedule, notify,
