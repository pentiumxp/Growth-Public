...
test("release union script registers the final release gate harness", () => {
  ...
  assert.equal(RELEASE_UNION_TEST_FILES.includes("tests/learning-automation-release-workbench-action-service.test.js"), true);
  assert.equal(RELEASE_UNION_TEST_FILES.includes("tests/learning-automation-release-workbench-action-repository.test.js"), true);
  assert.equal(RELEASE_UNION_TEST_FILES.includes("tests/growth-release-workbench-action-smoke-script.test.js"), true);
