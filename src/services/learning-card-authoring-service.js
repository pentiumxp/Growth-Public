...
function structuredAuthoringInput(input = {}) {
  ...
  return {
    ...
    domain: cleanString(input.domain || plan.domain),
    subject: cleanString(input.subject || plan.subject),
    ...
    rubricPolicy: boundedObject(input.rubricPolicy || input.rubric_policy),
