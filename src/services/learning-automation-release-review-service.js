...
function publicDashboardSummary(record = {}) {
  ...
  return {
    ...
    latestPreflightReportId: cleanString(dashboardSummary.latestPreflightReportId || dashboardSummary.latest_preflight_report_id, 180),
    latestPreflightStatus: cleanString(dashboardSummary.latestPreflightStatus || dashboardSummary.latest_preflight_status, 120),
    latestPreflightReadyForProductionDeployReview: dashboardSummary.latestPreflightReadyForProductionDeployReview === true || dashboardSummary.latest_preflight_ready_for_production_deploy_review === true,
    latestPreflightReadyForOwnerReleaseActivation: dashboardSummary.latestPreflightReadyForOwnerReleaseActivation === true || dashboardSummary.latest_preflight_ready_for_owner_release_activation === true,
...
function packageReadbackSummary(packageResult = {}, packageRecordStatus = "") {
  ...
  return {
    ...
    latestPackageDashboardPreflightReportId: cleanString(dashboard.latestPreflightReportId || dashboard.latest_preflight_report_id, 180),
    latestPackageDashboardPreflightStatus: cleanString(dashboard.latestPreflightStatus || dashboard.latest_preflight_status, 120),
    latestPackageDashboardPreflightReadyForProductionDeployReview: dashboard.latestPreflightReadyForProductionDeployReview === true || dashboard.latest_preflight_ready_for_production_deploy_review === true,
    latestPackageDashboardPreflightReadyForOwnerReleaseActivation: dashboard.latestPreflightReadyForOwnerReleaseActivation === true || dashboard.latest_preflight_ready_for_owner_release_activation === true,
    writefulSchedulingAllowed: false,
    runtimeConfigChange: false,
    configChangeApplied: false
  };
